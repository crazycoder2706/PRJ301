...
<html lang="en">
    ...
    <body>
        ...
        <div class="super_container">
            ...
            <!--header-->
            <%@include file="./HeadFood/headerAdmin.jsp" %>
                                    ...
                                    <tbody>
                                        <c:forEach items="${listO}" var="o">
                                            <tr>
                                                ...
                                                <th scope="row">
                                                    <c:if test="${o.comment == null || o.comment == ''}">
                                                        NO COMMENT
                                                    </c:if>
                                                    <c:if test="${o.comment != null && o.comment != ''}">
                                                        <p>${o.comment}</p>
                                                ...
                                                <th scope="row">                                                   
                                                    <a href="detailBill?orderDetailID=${o.orderDeitalID}"><i class="fa-solid fa-money-bill-wave"></i></a>
                                                </th>

                                                <th scope="row" >
                                                    <form action="manageOrder?action=delete" method="post">
                                                        <input name="orderDetailID" value="${o.orderDeitalID}" hidden/>
